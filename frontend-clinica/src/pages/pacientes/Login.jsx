            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-5 py-3.5 pr-12 rounded-2xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-clinica-dark focus:border-transparent transition-all bg-white/80"
                  placeholder="••••••••"
                />
